...
from client_portal.api import router as client_portal_router, urlpatterns as client_portal_urls
from case_rules.api import CalculateDeadlinesView
from services.ai.api import ContractAnalysisView

router = DefaultRouter()
for r in (accounts_router, matters_router, billing_router, portal_router, audit_router, notifications_router, client_portal_router):
